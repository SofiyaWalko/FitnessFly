...
import AdminTrainingSelectCard from "./AdminTrainingSelectCard";
...
function AdminProgramDay() {
	...
	function handleDelete(trainingId) {
		if (!window.confirm("Удалить тренировку из дня программы?")) return;
		fetch(
				...
				<div className={styles.modal}>
					<div className={styles.modalContentLarge}>
						...
						<div className={styles.modalActions}>
							<button onClick={handleAddSelected} className={styles.modal_button1}>
								Добавить выбранные
							</button>

							<button onClick={() => setSelected([])} className={styles.modal_button2}>
								Очистить выбор
							</button>
						</div>
					</div>
